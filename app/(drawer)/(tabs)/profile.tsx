                ...
                >
                    <View style={{ flexDirection: "row", alignItems: "center" }}>
                        <View style={{ position: "relative" }}>
                            <Image
                                source={{ uri: user?.avatar || "https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" }}
                                style={{
                                    width: 72,
                                    height: 72,
                                    borderRadius: 36,
                        ...
                        <View style={{ marginLeft: 16, flex: 1 }}>
                            <Text className="font-expressa" style={{ fontSize: 20, fontWeight: "700", color: colors.text }}>{user?.name || "Guest User"}</Text>
                            <Text style={{ fontSize: 13, color: colors.textSecondary, marginTop: 2 }}>{user?.email || "guest@example.com"}</Text>
                            <TouchableOpacity
                                style={{
                                    marginTop: 8,
